...
class Res101EncoderMC23(nn.Module):
    """
    ...
    def __init__(self, replace_stride_with_dilation=None, pretrained_weights='deeplabv3'):
        ...
        if pretrained_weights == 'deeplabv3':
            self.pretrained_weights = \
                torch.load("/Share/home/10014/songyuhui/work3/MC23/checkpoints/deeplabv3_resnet101_coco-586e9e4e.pth",
                map_location='cpu')
        elif pretrained_weights == 'resnet101':
            self.pretrained_weights = \
                torch.load("/Share/home/10014/songyuhui/work3/MC23/checkpoints/resnet101-63fe2227.pth",
             map_location='cpu')
        else:
        ...
        self.reduce1 = nn.Conv2d(1024, 512, kernel_size=(1, 1), bias=False)
        self.reduce2 = nn.Conv2d(2048, 512, kernel_size=(1, 1), bias=False)
    ...
    def forward(self, x):
        ...
        features['down32'] = self.reduce2(x)
