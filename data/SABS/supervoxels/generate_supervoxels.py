...
# base_dir = '/../sabs_CT_normalized'
base_dir = "C://Users/Administrator/Desktop/tools/SABS/sabs_CT_normalized"
...
if ~os.path.exists(f'supervoxels_{n_sv}/'):
    os.mkdir(f'supervoxels_{n_sv}/')
...
for img_path in imgs:
    ...
    seg_fid = os.path.join(f'supervoxels_{n_sv}/', f'superpix-{MODE}_{idx}.nii.gz')
